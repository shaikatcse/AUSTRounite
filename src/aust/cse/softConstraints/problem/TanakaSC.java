 ...
 */
public class TanakaSC extends Problem{    
  ...
  */
  public TanakaSC(String solutionType) {
    numberOfVariables_  = 2;
    numberOfObjectives_ = 2;
    numberOfConstraints_= 1;
    numberOfSoftConstraints_=1;
    problemName_        = "TanakaSC";
  ...
  */
  ...
  public void evaluateSoftConstraints(Solution solution) throws JMException {
	    ...
	    double x2 = solution.getDecisionVariables()[1].getValue();
	     ...
	     constraint[0] = - 2.0 * ( (x1-0.5)*(x1-0.5) + (x2-0.5)*(x2-0.5) - 0.5);
	    ...
	    solution.setOverallSoftConstraintViolation(total);    
	    solution.setNumberOfViolatedSoftConstraint(number);
	  } 
} // Tanaka