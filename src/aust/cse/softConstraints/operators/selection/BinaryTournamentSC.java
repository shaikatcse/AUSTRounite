...
package aust.cse.softConstraints.operators.selection;
 ...
 */
public class BinaryTournamentSC extends Selection {
   ...
   */
  public BinaryTournamentSC(HashMap<String, Object> parameters){
  	super(parameters) ;
      ...
      comparator_ = new DominanceComparatorSC();
  } // BinaryTournament
