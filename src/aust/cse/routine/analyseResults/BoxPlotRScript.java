...
public class BoxPlotRScript {
	...
	public static void main(String args[]) throws JMException, IOException {
		...
		BoxPlotRScript bps = new BoxPlotRScript();

		bps.algorithmNameList_ = new String[] {  "SmartInitWithSCBinaryTournament", "NoSoftConstBinaryTournament" };
		bps.indicatorList_ = new String[] {"HV",  "Epsilon", } ;

		int numberOfAlgorithms = bps.algorithmNameList_.length;

		bps.experimentBaseDirectory_ = "C:\\Users\\shaik\\Desktop\\ParetoFront";
