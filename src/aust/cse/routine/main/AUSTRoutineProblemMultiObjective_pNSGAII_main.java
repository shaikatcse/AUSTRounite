 ...
 * TSPLIB.
 */
public class AUSTRoutineProblemMultiObjective_pNSGAII_main {
  ...
  public static void main(String [] args)  throws FileNotFoundException, 
    ...
    for(int i=0;i<population.size();i++) {
    	System.out.println(population.get(i).getOverallConstraintViolation());
    }
    ...
    population.printFeasibleVAR("FIS_VAR");
  }//main
} // TSPGA_main
