...
package aust.cse.routine.operators.mutation;
 ...
 * must be Permutation.
 */
public class SwapMutationRoutineProblem extends SwapMutation{
  /**
   ...
   * Constructor
   */
  public SwapMutationRoutineProblem(HashMap<String, Object> parameters) {    
  	super(parameters) ;
